...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.profile',         'default': '640x480x15', 'description': 'depth module profile'},                           
                           ...
                           {'name': 'clip_distance',                'default': '3.0', 'description': "''"},                           
                           ...
                           {'name': 'spatial_filter.enable',        'default': 'true', 'description': 'Enable spatial filter'},
                           {'name': 'temporal_filter.enable',       'default': 'true', 'description': 'Enable temportal filter'},
                           {'name': 'hole_filling_filter.enable',   'default': 'false', 'description': 'Enable hole filling filter'},
                           {'name': 'color_qos',                    'default': 'DEFAULT', 'description': 'Color stream QoS profile'},
                           {'name': 'depth_qos',                    'default': 'DEFAULT', 'description': 'Depth stream QoS profile'}, # SENSOR_DATA
                           {'name': 'infra1_qos',                   'default': 'DEFAULT', 'description': 'Infra1 stream QoS profile'}, # SENSOR_DATA
                           {'name': 'infra2_qos',                   'default': 'DEFAULT', 'description': 'Infra2 stream QoS profile'}, # SENSOR_DATA
                        #    {'name': 'depth_module.emitter_on_off',  'default': 'true', 'description': 'emitter on/off for splitter'}
                           {'name': 'depth_module.emitter_enabled', 'default': '0', 'description': 'emitter on/off for splitter'}, # If using splitter, set to 1
                           {'name': 'pipeline_input', 'default': '/d455/depth/color/points', 'description': 'Input Point Cloud to the filter Pipeline'},
                           {'name': 'pipeline_output', 'default': '/d455/points/filtered', 'description': 'Output Point Cloud of the filter Pipeline'},
                           {'name': 'intra_process_comms', 'default': 'true', 'description': 'Realsense enable intra-process comms'}
                            ]
